...
if(isNil {_unit getVariable "cws_ais_unit_died"}) then {_unit setVariable ["cws_ais_unit_died", false]};
...
if(isNil {_unit getVariable "cws_ais_bleedout_time"}) then {_unit setVariable ["cws_ais_bleedout_time", 0]};
